...
#define GRANULARITY_4K 0x2
#define GRANULARITY_32bit 0x1

/**
 * set_gdt_gate() - install a gdt gate.
 * @base:		base address of the segment
 * @limit:		limit
 * @access:		access macro with dpl
 * @granularity:	granularity flags
 * @n:			index of the gate
 *
 * Set a segment into the GDT. The basic index are already defined, like
 * %KERNEL_CS, %KERNEL_DS, and so on.
 *
 * For the access part, you should use the macros : %CODE_SEGMENT,
 * %DATA_SEGMENT and %TSS_SEGMENT.
 *
 * Granularity is defined as 2 bits, in order to avoir having too much
 * arguments, you can use the already defined flags, like
 * GRANULARITY_4K|GRANULARITY_32bit for most cases.
 *
