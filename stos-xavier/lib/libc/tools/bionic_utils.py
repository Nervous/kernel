...
class SysCallsTxtParser:
    ...
    def parse_line(self, line):
		...
		# the syscall_id is the sycall number on arm
		# the syscall_id2 is the sycall number on i386
		# the syscall_id3 is the sycall number on sh
		# the syscall_id4 is the sycall number on sparc64
		# the syscall_id5 is the sycall number on sparc64
                syscall_id  = int(numbers[0])
                syscall_id2 = syscall_id
                syscall_id3 = syscall_id
                syscall_id4 = syscall_id
                syscall_id5 = syscall_id
                if len(numbers) > 1:
		...
		if len(numbers) > 3:
                    ...
                    syscall_id5 = syscall_id4
		if len(numbers) > 4:
                    syscall_id5 = int(numbers[4])
            except:
